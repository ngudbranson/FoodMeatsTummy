          ...
          <div className={classes.flex}>
            <MuiThemeProvider theme={theme}>
              <Typography className={classes.question} variant="headline" id="boxShadow">
                At some point during this week was someoneone else to blame for something bad that happened to you?
                <Typography variant="body2">
                  The person or thing responsible harmed you in some way, or prevented you from getting something you wanted.
                </Typography>
                <Typography variant="body2">
...
export default withStyles(styles)(QuestionOne);
...
// maybe have all questions in one component, just with conditional rendering