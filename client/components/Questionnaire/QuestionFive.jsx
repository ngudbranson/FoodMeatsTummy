          ...
          <div className={classes.flex}>
            <MuiThemeProvider theme={theme}>
              <Typography className={classes.question} variant="headline" id="boxShadow">
                At some point during this week did you experience an important loss and knew it was impossible to overcome?
                <Typography variant="body2">
                  The person or object that was lost was gone forever, and you knew nothing you could be done to change the situation.
                </Typography>
                <Typography variant="body2">
...
export default withStyles(styles)(QuestionFive);
