...
class QuestionSeven extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      currentNumber: 7,
          ...
          <div className={classes.flex}>
            <MuiThemeProvider theme={theme}>
              <Typography className={classes.question} variant="headline" id="boxShadow">
                At some point during this week did something wonderful happen?
                <Typography variant="body2">
                  You got something you wanted very much, or you achieved an important goal, or you had some other experience that was pleasant.
                </Typography>
                <Typography variant="body2">
...
export default withStyles(styles)(QuestionSeven);
