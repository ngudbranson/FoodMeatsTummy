          ...
          <div className={classes.flex}>
            <MuiThemeProvider theme={theme}>
              <Typography className={classes.question} variant="headline" id="boxShadow">
                At some point during this week were you in danger?
                <Typography variant="body2">
                  You were threatened with some degree of harm and you were uncertain of how to deal with the situation, or felt unable to cope.
                </Typography>
                <Typography variant="body2">
